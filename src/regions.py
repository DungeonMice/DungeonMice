...
_OVERLAP_GRID_STEPS = 5  # Resolución de la grilla de muestreo (5x5 = 25 puntos)
...
class CircularFractionRegion(Region):
    ...
    def __init__(self, region_id, center, radius, angle_start=0.0,
                 angle_end=None, fraction=None, overlap_threshold: float = 0.0):
        ...
        Args:
            ...
            fraction: Fracción del círculo en (0, 1]. Excluyente con ``angle_end``.
            overlap_threshold: Fracción mínima de solapamiento. Ver ``Region``.
    ...
    def mask(self, shape):
        ...
        cv2.ellipse(
            ...
            0, self.angle_start, self.angle_end, 255, -1,
        )
        return mask
